    ...
    value: function render() {
      ...
      var sorter = [{
        ...
        index: 9, condition: true, dom: _react2.default.createElement(
          _toolbarButton2.default,
          {
            active: [_constants.MODE_WAITING_DRAWING_LINE].includes(mode),
            tooltip: 'Wall',
            onClick: function onClick(e) {
              return _this2.catalogQuickSelect(wallElement);
            } },
          _react2.default.createElement(_gi.GiBrickWall, null)
        )
      }, {
        index: 10, condition: true, dom: _react2.default.createElement(
          _toolbarButton2.default,
          {
            active: !!([_constants.MODE_DRAWING_HOLE].includes(mode) && currentSelectedElement && currentSelectedElement.name === 'gate'),
            tooltip: 'Gate',
            onClick: function onClick(e) {
              return _this2.catalogQuickSelect(gateElement);
            } },
          _react2.default.createElement(_gi.GiDungeonGate, null)
        )
      }, {
        index: 11, condition: true, dom: _react2.default.createElement(
          _toolbarButton2.default,
          {
            active: !!([_constants.MODE_DRAWING_HOLE].includes(mode) && currentSelectedElement && currentSelectedElement.name === 'door'),
            tooltip: 'Door',
            onClick: function onClick(e) {
              return _this2.catalogQuickSelect(doorElement);
            } },
          _react2.default.createElement(_fa.FaDoorOpen, null)
        )
      }];
